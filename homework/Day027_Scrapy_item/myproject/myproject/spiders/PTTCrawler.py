...
# 範例目標網址: https://www.ptt.cc/bbs/Gossiping/M.1578118053.A.125.htmls
class PttcrawlerSpider(scrapy.Spider):
    name = 'PTTCrawler'
    allowed_domains = ['https://www.ptt.cc/bbs/Gossiping/M.1578118053.A.125.html']
    start_urls = ['https://www.ptt.cc/bbs/Gossiping/M.1578118053.A.125.html']
    cookies = {'over18': '1'}
